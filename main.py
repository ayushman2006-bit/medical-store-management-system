...
tree.column("Qty", width=80,anchor="w", stretch=False)
tree.column("Price", width=100,anchor="w", stretch=False)
tree.column("Expiry", width=120,anchor="w", stretch=False)
...
def view_bill_history():
    ...
    bill_tree.column("Date", width=250)
    bill_tree.column("Total", width=150)
